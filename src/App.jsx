...
const keynoteProcessSlides = {
  ...
  "14": {
    ...
    textLayers: [
      ...
      textLayer("subtitle", "随着理想同学全新形象上线，需要确保一个月内将近 600段 的资源素材产出\n我主负责把控整个项目节奏，因为我最了解整个项目的进度以及所有的技术交付，所以我在团队协作中负责 补位协调 。", [18.5, 14.2, 63, 6.4], { highlightTerms: ["一个月内", "600段", "补位协调"] }),
  ...
  "16": {
    ...
    textLayers: [
      ...
      textLayer("subtitle", "我在不断探索 Ai能力边界、AI生图当前阶段的最大问题就是 成功率 影响效率。", [28, 15.5, 44, 5], { highlightTerms: ["Ai能力边界", "成功率"] }),
      textLayer("columnTitle", "批量工作流", [27.6, 76.3, 18, 4.5]),
      textLayer("columnBody", "通过API调用定制化生图工作流\n生图和视频效率\n提升 50%\n正向生图成功率和生图时间是损耗\n但是逆向筛选就能快很多", [27.6, 81.3, 24, 14], { highlightTerms: ["提升 50%"] }),
  ...
  "24": {
    ...
    textLayers: [
      ...
      textLayer("subtitle", "设计注意力系统，用来判断注意力对象。通过摄像头捕捉，获得一个 注意力锚点\n将锚点的坐标传递至驱动器，从而实现注意力观察的效果", [28, 16.1, 44, 6.5], { highlightTerms: ["注意力系统", "注意力锚点"] }),
    ],
  },
  "25": {
    variant: "full-slide",
